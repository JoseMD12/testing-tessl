...
2. **Automação do Linter:** A formatação estética (como linhas em branco e recuos) é tratada automaticamente. Antes de enviar alterações, execute a validação e correção automática através do comando:
